...
-- AddForeignKey
ALTER TABLE "Console"
ADD CONSTRAINT "Console_brandId_fkey" FOREIGN KEY ("brandId") REFERENCES "Brand"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
-- AddForeignKey
ALTER TABLE "ConsoleVariant"
ADD CONSTRAINT "ConsoleVariant_consoleId_fkey" FOREIGN KEY ("consoleId") REFERENCES "Console"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
-- AddForeignKey
ALTER TABLE "Skin"
ADD CONSTRAINT "Skin_consoleVariantId_fkey" FOREIGN KEY ("consoleVariantId") REFERENCES "ConsoleVariant"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
-- AddForeignKey
ALTER TABLE "Accessory"
ADD CONSTRAINT "Accessory_consoleId_fkey" FOREIGN KEY ("consoleId") REFERENCES "Console"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
-- AddForeignKey
ALTER TABLE "GameEdition"
ADD CONSTRAINT "GameEdition_gameId_fkey" FOREIGN KEY ("gameId") REFERENCES "Game"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
-- AddForeignKey
ALTER TABLE "GameEdition"
ADD CONSTRAINT "GameEdition_consoleId_fkey" FOREIGN KEY ("consoleId") REFERENCES "Console"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
-- AddForeignKey
...
-- AddForeignKey
ALTER TABLE "UserItem"
ADD CONSTRAINT "UserItem_gameId_fkey" FOREIGN KEY ("gameId") REFERENCES "Game"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
-- AddForeignKey
ALTER TABLE "UserItem"
ADD CONSTRAINT "UserItem_consoleId_fkey" FOREIGN KEY ("consoleId") REFERENCES "Console"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
-- AddForeignKey
ALTER TABLE "UserConsole"
ADD CONSTRAINT "UserConsole_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
-- AddForeignKey
ALTER TABLE "UserConsole"
ADD CONSTRAINT "UserConsole_consoleId_fkey" FOREIGN KEY ("consoleId") REFERENCES "Console"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
-- AddForeignKey
ALTER TABLE "UserConsole"
ADD CONSTRAINT "UserConsole_consoleVariantId_fkey" FOREIGN KEY ("consoleVariantId") REFERENCES "ConsoleVariant"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
-- AddForeignKey
ALTER TABLE "UserConsole"
ADD CONSTRAINT "UserConsole_skinId_fkey" FOREIGN KEY ("skinId") REFERENCES "Skin"("id") ON DELETE
SET NULL ON UPDATE CASCADE;
-- AddForeignKey
ALTER TABLE "ConsoleTranslation"
ADD CONSTRAINT "ConsoleTranslation_consoleId_fkey" FOREIGN KEY ("consoleId") REFERENCES "Console"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
-- AddForeignKey
ALTER TABLE "ConsoleVariantTranslation"
ADD CONSTRAINT "ConsoleVariantTranslation_consoleVariantId_fkey" FOREIGN KEY ("consoleVariantId") REFERENCES "ConsoleVariant"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
-- AddForeignKey
ALTER TABLE "SkinTranslation"
ADD CONSTRAINT "SkinTranslation_skinId_fkey" FOREIGN KEY ("skinId") REFERENCES "Skin"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
-- AddForeignKey
ALTER TABLE "AccessoryTranslation"
ADD CONSTRAINT "AccessoryTranslation_accessoryId_fkey" FOREIGN KEY ("accessoryId") REFERENCES "Accessory"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
-- AddForeignKey
ALTER TABLE "GameTranslation"
ADD CONSTRAINT "GameTranslation_gameId_fkey" FOREIGN KEY ("gameId") REFERENCES "Game"("id") ON DELETE RESTRICT ON UPDATE CASCADE;